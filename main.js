...
var uniqueSkills = [
  ...
  {
    name: "Vampiric Touch",
    description: "Drains life from enemy, healing you for 50% of the damage dealt",
    rarity: "rare"
  },
  {
...
var GamificationPlugin = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
  ...
  async chooseClass() {
    ...
    this.data.skills = {};
    skills.filter((skill) => skill.classes.includes(className)).forEach((skill) => {
...
var GamificationSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    let classValue;
    new import_obsidian.Setting(containerEl).setName("Class").setDesc("Choose your class").addDropdown(async (drop) => {
