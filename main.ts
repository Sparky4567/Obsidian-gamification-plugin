...
const uniqueSkills = [
  ...
  },
  {
    name: "Chrono Shift",
    description:
      "Reverses the flow of time for 3 seconds, resetting your cooldowns",
    rarity: "legendary",
  },
  {
  ...
  },
  {
    name: "Shadowmeld",
    description:
      "Becomes invisible to enemies for 10 seconds or until you attack",
    rarity: "rare",
  },
  {
    name: "Ethereal Blade",
    description:
      "Summons a ghostly sword that deals extra damage for 15 seconds",
    rarity: "unique",
  },
  {
    name: "Mirror Image",
  ...
  },
  {
    name: "Blood Pact",
    description:
      "Sacrifices health to greatly increase damage output for 30 seconds",
    rarity: "unique",
  },
  {
